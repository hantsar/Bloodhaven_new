...
public class Entity_Stats : MonoBehaviour
{
    ...
    public float GetEvasion()
    {
        ...
        float bonusEvasion = major.agility.GetValue() * .5f; // each agility point -  +0.5% evasion

        float totalEvasion = baseEvasion + bonusEvasion;
        float evasionCup = 85f; // evasion will be capped at 85%

        float finalEvasion = Mathf.Clamp(totalEvasion, 0, evasionCup);
